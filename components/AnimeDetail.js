      ...
      <div>
        ...
        <Row>
          <Col md={3}>
            ...
            <p>
              <b>Rating:</b>{" "}
              {detail.data.rating ? detail.data.rating : "Unknown"}
            </p>
                    ...
                    <Col>
                      {anime.entry.map((e, index) => {
                        if (anime.relation === "Adaptation") {
                          ...
                          return e.length > 1 ? (
                            <>
                              <Link key={e.mal_id} href={`/animeDetail/${e.mal_id}`}>{e.name}</Link>
                            </>
                          ) : (
                            <Link  key={e.mal_id} href={`/animeDetail/${e.mal_id}`}>
                              {e.name}
